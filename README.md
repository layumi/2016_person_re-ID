...
2. Download the pretrained model. 
	...
	You can find the pretrained model in [GoogleDriver](https://drive.google.com/open?id=0B0VOCNYh8HeRWks0V24xTlpKWkU) or [BaiduYun] (https://pan.baidu.com/s/1mhKoQ4S). Download and put them into the `./data`.
